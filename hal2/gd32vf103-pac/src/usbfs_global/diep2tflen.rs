#[doc = "Reader of register DIEP2TFLEN"]
pub type R = crate::R<u32, super::DIEP2TFLEN>;
#[doc = "Writer for register DIEP2TFLEN"]
pub type W = crate::W<u32, super::DIEP2TFLEN>;
#[doc = "Register DIEP2TFLEN `reset()`'s with value 0x0200_0400"]
impl crate::ResetValue for super::DIEP2TFLEN {
    type Type = u32;
    #[inline(always)]
