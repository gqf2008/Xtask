#[doc = "Reader of register CH5MADDR"]
pub type R = crate::R<u32, super::CH5MADDR>;
#[doc = "Writer for register CH5MADDR"]
pub type W = crate::W<u32, super::CH5MADDR>;
#[doc = "Register CH5MADDR `reset()`'s with value 0"]
impl crate::ResetValue for super::CH5MADDR {
    type Type = u32;
    #[inline(always)]
