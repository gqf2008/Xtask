#[doc = "Reader of register TMDATA11"]
pub type R = crate::R<u32, super::TMDATA11>;
#[doc = "Writer for register TMDATA11"]
pub type W = crate::W<u32, super::TMDATA11>;
#[doc = "Register TMDATA11 `reset()`'s with value 0"]
impl crate::ResetValue for super::TMDATA11 {
    type Type = u32;
    #[inline(always)]
