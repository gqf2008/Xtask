...
macro_rules! sprintln {
    ...
    ($s:expr) => {
        $crate::sync::free(|_|$crate::bsp::longan_nano::stdout::write_str(concat!(file!(),":",line!()," ",$s, "\n")))
    };
    ($s:expr, $($tt:tt)*) => {
        $crate::sync::free(|_|$crate::bsp::longan_nano::stdout::write_fmt(format_args!(concat!(file!(),":",line!()," ",$s, "\n"), $($tt)*)))
    };
}
