...
// ============ 第 27 章:迷你 TLSF(两引擎直驱,与全局分配器后端选择无关) ============
...
/// 测试 18:棋盘格物理碎片——两引擎共限(第 27 章的诚实底线执行级复现)。
...
/// 书稿 ch28 踩坑 4 的诚实边界由此关闭:考官挂起后全系统零就绪、零期限,
