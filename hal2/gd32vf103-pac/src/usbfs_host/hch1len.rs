#[doc = "Reader of register HCH1LEN"]
pub type R = crate::R<u32, super::HCH1LEN>;
#[doc = "Writer for register HCH1LEN"]
pub type W = crate::W<u32, super::HCH1LEN>;
#[doc = "Register HCH1LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::HCH1LEN {
    type Type = u32;
    #[inline(always)]
