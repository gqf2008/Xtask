#[doc = "Register `clicint8` reader"]
pub struct R(crate::R<CLICINT8_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLICINT8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLICINT8_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLICINT8_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `clicint8` writer"]
pub struct W(crate::W<CLICINT8_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLICINT8_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLICINT8_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLICINT8_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type IP_W<'a> = crate::BitWriter<'a, u32, CLICINT8_SPEC, bool, 0>;
#[doc = "Field `IE` reader - Interrupt enable bit"]
pub type IE_R = crate::BitReader<bool>;
#[doc = "Field `IE` writer - Interrupt enable bit"]
pub type IE_W<'a> = crate::BitWriter<'a, u32, CLICINT8_SPEC, bool, 8>;
...
pub type TRIG_W<'a> = crate::FieldWriter<'a, u32, CLICINT8_SPEC, u8, u8, 3, 17>;
...
pub type SHV_W<'a> = crate::BitWriter<'a, u32, CLICINT8_SPEC, bool, 16>;
...
pub type LEVELPRIORITY_W<'a> = crate::FieldWriter<'a, u32, CLICINT8_SPEC, u8, u8, 8, 24>;
impl R {
...
#[doc = "Interrupt control and state\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [clicint8](index.html) module"]
pub struct CLICINT8_SPEC;
impl crate::RegisterSpec for CLICINT8_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [clicint8::R](R) reader structure"]
impl crate::Readable for CLICINT8_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [clicint8::W](W) writer structure"]
impl crate::Writable for CLICINT8_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets clicint8 to value 0"]
impl crate::Resettable for CLICINT8_SPEC {
    #[inline(always)]
