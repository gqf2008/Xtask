#[doc = "Reader of register HCH3LEN"]
pub type R = crate::R<u32, super::HCH3LEN>;
#[doc = "Writer for register HCH3LEN"]
pub type W = crate::W<u32, super::HCH3LEN>;
#[doc = "Register HCH3LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::HCH3LEN {
    type Type = u32;
    #[inline(always)]
