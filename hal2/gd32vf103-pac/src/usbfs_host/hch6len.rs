#[doc = "Reader of register HCH6LEN"]
pub type R = crate::R<u32, super::HCH6LEN>;
#[doc = "Writer for register HCH6LEN"]
pub type W = crate::W<u32, super::HCH6LEN>;
#[doc = "Register HCH6LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::HCH6LEN {
    type Type = u32;
    #[inline(always)]
