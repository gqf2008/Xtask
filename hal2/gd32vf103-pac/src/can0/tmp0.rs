#[doc = "Reader of register TMP0"]
pub type R = crate::R<u32, super::TMP0>;
#[doc = "Writer for register TMP0"]
pub type W = crate::W<u32, super::TMP0>;
#[doc = "Register TMP0 `reset()`'s with value 0"]
impl crate::ResetValue for super::TMP0 {
    type Type = u32;
    #[inline(always)]
