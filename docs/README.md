...
| ch57x | 官方 EVT 源码包（本仓按源码核对：`Startup/startup_CH572.S`、`Ld/Link.ld`、`RVMSIS/core_riscv.h`、`StdPeriphDriver/inc/{CH572SFR.h,CH57x_common.h}`） | `ch572`（青稞**无 A 扩展**；DS/PM 正式手册未入库，寄存器语义以官方 EVT 源码为准） | [openwch/ch570](https://github.com/openwch/ch570) |
