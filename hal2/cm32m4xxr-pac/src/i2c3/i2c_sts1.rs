...
#[doc = "Field `BYTEF` reader - BYTEF"]
pub type BYTEF_R = crate::BitReader<bool>;
#[doc = "Field `BYTEF` writer - BYTEF"]
pub type BYTEF_W<'a> = crate::BitWriter<'a, u32, I2C_STS1_SPEC, bool, 2>;
...
#[doc = "Field `STOPF_` reader - STOPF_"]
pub type STOPF__R = crate::BitReader<bool>;
#[doc = "Field `STOPF_` writer - STOPF_"]
pub type STOPF__W<'a> = crate::BitWriter<'a, u32, I2C_STS1_SPEC, bool, 4>;
...
impl R {
    ...
    #[doc = "Bit 2 - BYTEF"]
    #[inline(always)]
    pub fn bytef(&self) -> BYTEF_R {
        BYTEF_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - ADDR10F"]
    #[inline(always)]
    ...
    #[doc = "Bit 4 - STOPF_"]
    #[inline(always)]
    pub fn stopf_(&self) -> STOPF__R {
        STOPF__R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 6 - RXDATNE"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 4 - STOPF_"]
    #[inline(always)]
    pub fn stopf_(&mut self) -> STOPF__W {
        STOPF__W::new(self)
    }
    #[doc = "Bit 6 - RXDATNE"]
    #[inline(always)]
