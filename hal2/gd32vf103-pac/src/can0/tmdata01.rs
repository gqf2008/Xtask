#[doc = "Reader of register TMDATA01"]
pub type R = crate::R<u32, super::TMDATA01>;
#[doc = "Writer for register TMDATA01"]
pub type W = crate::W<u32, super::TMDATA01>;
#[doc = "Register TMDATA01 `reset()`'s with value 0"]
impl crate::ResetValue for super::TMDATA01 {
    type Type = u32;
    #[inline(always)]
