#[doc = "Reader of register TMDATA00"]
pub type R = crate::R<u32, super::TMDATA00>;
#[doc = "Writer for register TMDATA00"]
pub type W = crate::W<u32, super::TMDATA00>;
#[doc = "Register TMDATA00 `reset()`'s with value 0"]
impl crate::ResetValue for super::TMDATA00 {
    type Type = u32;
    #[inline(always)]
