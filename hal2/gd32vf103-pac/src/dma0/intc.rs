...
#[doc = "Write proxy for field `GIFC5`"]
pub struct GIFC5_W<'a> {
    w: &'a mut W,
}
impl<'a> GIFC5_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Write proxy for field `ERRIFC5`"]
pub struct ERRIFC5_W<'a> {
    w: &'a mut W,
}
impl<'a> ERRIFC5_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Write proxy for field `GIFC6`"]
pub struct GIFC6_W<'a> {
    w: &'a mut W,
}
impl<'a> GIFC6_W<'a> {
    #[doc = r"Sets the field bit"]
...
#[doc = "Write proxy for field `ERRIFC6`"]
pub struct ERRIFC6_W<'a> {
    w: &'a mut W,
}
impl<'a> ERRIFC6_W<'a> {
    #[doc = r"Sets the field bit"]
