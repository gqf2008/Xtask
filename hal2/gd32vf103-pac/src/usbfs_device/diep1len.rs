#[doc = "Reader of register DIEP1LEN"]
pub type R = crate::R<u32, super::DIEP1LEN>;
#[doc = "Writer for register DIEP1LEN"]
pub type W = crate::W<u32, super::DIEP1LEN>;
#[doc = "Register DIEP1LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::DIEP1LEN {
    type Type = u32;
    #[inline(always)]
