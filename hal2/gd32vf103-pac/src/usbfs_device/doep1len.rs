#[doc = "Reader of register DOEP1LEN"]
pub type R = crate::R<u32, super::DOEP1LEN>;
#[doc = "Writer for register DOEP1LEN"]
pub type W = crate::W<u32, super::DOEP1LEN>;
#[doc = "Register DOEP1LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::DOEP1LEN {
    type Type = u32;
    #[inline(always)]
