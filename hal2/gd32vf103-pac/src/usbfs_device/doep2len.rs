#[doc = "Reader of register DOEP2LEN"]
pub type R = crate::R<u32, super::DOEP2LEN>;
#[doc = "Writer for register DOEP2LEN"]
pub type W = crate::W<u32, super::DOEP2LEN>;
#[doc = "Register DOEP2LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::DOEP2LEN {
    type Type = u32;
    #[inline(always)]
