#[doc = "Reader of register HCH2LEN"]
pub type R = crate::R<u32, super::HCH2LEN>;
#[doc = "Writer for register HCH2LEN"]
pub type W = crate::W<u32, super::HCH2LEN>;
#[doc = "Register HCH2LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::HCH2LEN {
    type Type = u32;
    #[inline(always)]
