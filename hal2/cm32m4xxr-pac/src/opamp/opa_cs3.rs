#[doc = "Register `OPA_CS3` reader"]
pub struct R(crate::R<OPA_CS3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<OPA_CS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<OPA_CS3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<OPA_CS3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `OPA_CS3` writer"]
pub struct W(crate::W<OPA_CS3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<OPA_CS3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<OPA_CS3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<OPA_CS3_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "OPA_CS3\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [opa_cs3](index.html) module"]
pub struct OPA_CS3_SPEC;
impl crate::RegisterSpec for OPA_CS3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [opa_cs3::R](R) reader structure"]
impl crate::Readable for OPA_CS3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [opa_cs3::W](W) writer structure"]
impl crate::Writable for OPA_CS3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets OPA_CS3 to value 0"]
impl crate::Resettable for OPA_CS3_SPEC {
    #[inline(always)]
