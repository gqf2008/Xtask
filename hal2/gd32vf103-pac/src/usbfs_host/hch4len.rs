#[doc = "Reader of register HCH4LEN"]
pub type R = crate::R<u32, super::HCH4LEN>;
#[doc = "Writer for register HCH4LEN"]
pub type W = crate::W<u32, super::HCH4LEN>;
#[doc = "Register HCH4LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::HCH4LEN {
    type Type = u32;
    #[inline(always)]
