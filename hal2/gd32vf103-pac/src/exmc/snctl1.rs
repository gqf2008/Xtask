#[doc = "Reader of register SNCTL1"]
pub type R = crate::R<u32, super::SNCTL1>;
#[doc = "Writer for register SNCTL1"]
pub type W = crate::W<u32, super::SNCTL1>;
#[doc = "Register SNCTL1 `reset()`'s with value 0x30da"]
impl crate::ResetValue for super::SNCTL1 {
    type Type = u32;
    #[inline(always)]
