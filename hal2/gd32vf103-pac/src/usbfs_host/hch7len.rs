#[doc = "Reader of register HCH7LEN"]
pub type R = crate::R<u32, super::HCH7LEN>;
#[doc = "Writer for register HCH7LEN"]
pub type W = crate::W<u32, super::HCH7LEN>;
#[doc = "Register HCH7LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::HCH7LEN {
    type Type = u32;
    #[inline(always)]
