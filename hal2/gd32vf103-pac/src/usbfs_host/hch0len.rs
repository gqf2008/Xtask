#[doc = "Reader of register HCH0LEN"]
pub type R = crate::R<u32, super::HCH0LEN>;
#[doc = "Writer for register HCH0LEN"]
pub type W = crate::W<u32, super::HCH0LEN>;
#[doc = "Register HCH0LEN `reset()`'s with value 0"]
impl crate::ResetValue for super::HCH0LEN {
    type Type = u32;
    #[inline(always)]
